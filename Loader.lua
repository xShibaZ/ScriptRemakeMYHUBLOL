	...
	getgenv()['Check_Setting'] = function(Name)
		if not _G.Dis and not isfolder('Salad X Hub BF Premium') then
			makefolder('Salad X Hub BF Premium')
		end
		if not _G.Dis and not isfile('Salad X Hub BF Premium/'..Name..'.json') then
			writefile('Salad X Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
		end
	end
	getgenv()['Get_Setting'] = function(Name)
		if not _G.Dis and isfolder('Salad X Hub BF Premium') and isfile('Salad X Hub BF Premium/'..Name..'.json') then
			_G.Setting_table = JsonDecode(readfile('Salad X Hub BF Premium/'..Name..'.json'))
	...
	local win = library:Window("Salad X ",[[Hub                                  REMAKE !]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
